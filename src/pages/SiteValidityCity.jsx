...
const FEES = [
  { label: 'المقابل الفني', amount: '450.00' },
  { label: 'ضريبة القيمة المضافة (14%)', amount: '63.00', plus: true },
...
const TABS = [
  ...
  { id: 'terms', label: 'الشروط والأحكام', Icon: HiOutlineClipboardDocumentCheck },
];

const SiteValidityCity = () => {
  ...
  const handleTrack = (e) => {
    ...
    setTrackResult({ code: requestCode, status: 'قيد المراجعة الفنية' });
  };

  return (
    <div className="bg-[#f0f4f8] min-h-screen font-cairo overflow-x-hidden">

      <PageHero title="صلاحية الموقع (مدينة)" subtitle="خدمة رقمية موثقة بالكامل — تقديم إلكتروني دون الحاجة لزيارة المركز" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-4 flex flex-col order-2 lg:order-1">
            ...
            >
              ...
              <div className="bg-[#f4f7f9] px-6 py-4 flex items-center justify-between border-t border-gray-100">
                <div>
                  <span className="text-2xl font-black text-navy tabular-nums tracking-tight">528.00</span>
          ...
          <div className="lg:col-span-8 order-1 lg:order-2 flex flex-col">
            ...
            >
              ...
              {/* Tab Content */}
              <div className="px-6 lg:px-8 py-6" dir="rtl">
                    ...
                    >
                      <div className="flex items-start gap-4 mb-5">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-xs">خدمة الاستعلام عن صلاحية موقع المدينة</p>
                        </div>
                      </div>
                      <div className="bg-gradient-to-l from-blue-50 to-indigo-50/50 rounded-2xl p-5 mb-6">
                        <p className="text-gray-700 leading-loose text-base">
                          خدمة يتقدم عليها المواطن تمهيداً لاستخراج رخصة البناء داخل المدن، يُحدَّد بها
                          الاشتراطات البنائية والتخطيطية طبقاً للمخططات التفصيلية المعتمَدة للمدينة.
                        </p>
                      </div>
                      ...
                      <div className="mt-6 grid grid-cols-2 gap-4">
                        {[
                          ...
                          { label: 'الجهة المختصة', value: 'مدينة كفر الشيخ' },
                    ...
                    >
                      <div className="flex items-start gap-4 mb-6">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-xs">يرجى التأكد من توافر جميع الوثائق قبل التقديم</p>
                        </div>
                      </div>
                      <div className="space-y-2">
                        {[
                          'صورة بطاقة الرقم القومي سارية للمواطن.',
                          'سند ملكية الأرض أو العقار المراد ترخيصه بالمدينة.',
                          'الرفع المساحي المعتمد من مهندس نقابي أو جهة مساحية معتمدة.',
                          'إيصال سداد كافة الرسوم المستحقة للخدمة.',
                        ].map((doc, idx) => (
                          <div key={idx} className="flex items-start gap-3 bg-[#f8fafc] border border-gray-100 hover:border-gold/30 hover:bg-gold/5 p-3 rounded-xl transition-all duration-200 group">
                            <div className="w-7 h-7 rounded-lg bg-gold/15 flex items-center justify-center shrink-0 mt-0.5 group-hover:bg-gold/25 transition-colors">
                              <HiCheckCircle className="text-gold" size={16} />
                            </div>
                            <span className="text-gray-700 text-sm font-medium leading-snug pt-0.5">{doc}</span>
                          </div>
                        ))}
                      </div>
                    </motion.div>
                    ...
                    >
                      <div className="flex items-start gap-4 mb-6">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-xs">يُرجى الاطلاع على جميع الشروط قبل تقديم الطلب</p>
                        </div>
                      </div>
                      <div className="space-y-2">
                        {[
                          'أن يكون الموقع واقعاً داخل الحيز العمراني المعتمَد للمدينة.',
                          'الالتزام بقيد الارتفاع والخطوط التنظيمية المعتمدة للمنطقة.',
                          'عدم وجود أي مخالفات أو تعديات سابقة على الخط التنظيمي.',
                          'تقديم كافة المستندات والتراخيص السابقة إن وجدت.',
                        ].map((term, idx) => (
                          <div key={idx} className="flex items-start gap-3 bg-[#f8fafc] border border-gray-100 hover:border-navy/20 hover:bg-navy/5 p-3 rounded-xl transition-all duration-200 group">
                            <div className="w-7 h-7 rounded-lg bg-navy/10 flex items-center justify-center shrink-0 mt-0.5 group-hover:bg-navy/15 transition-colors">
                              <HiOutlineCheckCircle className="text-navy" size={16} />
                            </div>
                            <span className="text-gray-700 text-sm font-medium leading-snug pt-0.5">{term}</span>
                          </div>
                        ))}
                      </div>
                    </motion.div>
      ...
      {/* ── Full-Width CTA Section — Attached to Footer ── */}
...
export default SiteValidityCity;
