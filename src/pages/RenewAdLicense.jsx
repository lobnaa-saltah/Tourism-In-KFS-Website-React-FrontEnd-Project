...
const RenewAdLicense = () => {
  ...
  return (
    <div className="bg-[#f8fafc] min-h-screen font-cairo overflow-x-hidden pb-20" dir="rtl">
      ...
      <PageHero title="تجديد ترخيص إعلان قائم" subtitle={null} />
          ...
          <div className="lg:col-span-8 order-1 lg:order-2 space-y-6">
            ...
            >
              <p className="text-gray-700 leading-loose text-sm lg:text-base font-normal">
                تخص هذه الخدمة لأصحاب التراخيص السارية التي أوشكت على الانتهاء أو انتهت بالفعل، وذلك لتمديد فترة صلاحية الإعلان في موقعه الحالي. يرجى التأكد من مطابقة حالة الإعلان الفعلية للترخيص الأصلي لضمان قبول الطلب.
              </p>
            </motion.div>
