...
const SiteValidityVillage = () => {
  ...
  return (
    <div className="bg-[#f0f4f8] min-h-screen font-cairo overflow-x-hidden">
      ...
      <PageHero title="صلاحية الموقع (قرية)" subtitle="خدمة رقمية موثقة بالكامل — تقديم إلكتروني دون الحاجة لزيارة المركز" />
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                      <div className="flex items-start gap-4 mb-5">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-xs">خدمة الاستعلام عن صلاحية موقع القرية</p>
                        </div>
                      </div>
                      <div className="bg-gradient-to-l from-blue-50 to-indigo-50/50 rounded-2xl p-5 mb-6">
                        <p className="text-gray-700 leading-loose text-base">
                          خدمة يتقدم عليها المواطن تمهيداً لاستخراج رخصة البناء، يُحدَّد بها الاشتراطات البنائية
                          والتخطيطية طبقاً للمخططات التفصيلية المعتمَدة.
                        </p>
                      </div>
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        {[
                          ...
                          'سند ملكية الأرض أو العقار المراد ترخيصه.',
                          'خريطة مساحية أو كروكي معتمد من الإدارة المساحية.',
                  ...
                  {activeTab === 'terms' && (
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        {[
                          'أن يكون الموقع واقعاً داخل الحيز العمراني المعتمَد للقرية.',
                          'عدم وجود أي مخالفات أو تعديات على أملاك الدولة أو الأراضي الزراعية.',
                          'التزام المتقدم بكافة الاشتراطات البنائية والتخطيطية الصادرة عن الجهات المختصة.',
                          'إدخال كافة البيانات والمستندات المطلوبة بشكل صحيح ودقيق.',
                        ].map((term, idx) => (
...
export default SiteValidityVillage;
