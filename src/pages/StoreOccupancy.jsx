...
const FEES = [
  { label: 'المقابل الفني', amount: '1,100.00' },
  { label: 'ضريبة القيمة المضافة (14%)', amount: '154.00', plus: true },
...
const StoreOccupancy = () => {
  ...
  const handleTrack = (e) => {
    ...
    setTrackResult({
      code: requestCode,
      status: 'طلبك قيد المراجعة الفنية لدى إدارة الإشغالات.',
    });
  };
  ...
  return (
    <div className="bg-[#f8fafc] min-h-screen font-cairo overflow-x-hidden" dir="rtl">
      ...
      <PageHero title="إشغال أمام المحال وتند المحال" subtitle="خدمة رقمية موثقة بالكامل — تقديم إلكتروني دون الحاجة لزيارة المركز" />
          ...
          <div className="lg:col-span-4 flex flex-col order-2 lg:order-1">
            ...
            >
              ...
              <div className="bg-[#f4f7f9] px-6 py-4 flex items-center justify-between border-t border-gray-100">
                <div>
                  <span className="text-2xl font-black text-navy tabular-nums tracking-tight">1,269.00</span>
                    ...
                    >
                      <div className="flex items-start gap-4 mb-5">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-xs">خدمة تصاريح الإشغالات والتند للمحال التجارية</p>
                        </div>
                      </div>
                  ...
                  {activeTab === 'documents' && (
                    ...
                    >
                      ...
                      <div className="space-y-3">
                        {[
                          'صورة الرقم القومي.',
                          'صورة رخصة الإشغال السابقة إن وجدت.',
                        ].map((doc, idx) => (
