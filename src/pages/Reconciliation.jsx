...
const FEES = [
  { label: 'المقابل الفني', amount: '500.00' },
  { label: 'ضريبة القيمة المضافة (14%)', amount: '70.00', plus: true },
...
const Reconciliation = () => {
  ...
  const handleTrack = (e) => {
    ...
    setTrackResult({
      code: requestCode,
      status: 'طلبك قيد المراجعة الفنية لدى لجنة التصالح.',
    });
  };
  ...
  return (
    <div className="bg-[#f8fafc] min-h-screen font-cairo overflow-x-hidden" dir="rtl">
      ...
      <PageHero title="التصالح" subtitle="خدمة رقمية موثقة بالكامل — تقديم إلكتروني دون الحاجة لزيارة المركز" />
          ...
          <div className="lg:col-span-4 flex flex-col order-2 lg:order-1">
            ...
            >
              ...
              <div className="bg-[#f4f7f9] px-6 py-4 flex items-center justify-between border-t border-gray-100">
                <div>
                  <span className="text-2xl font-black text-navy tabular-nums tracking-tight">585.00</span>
                    ...
                    >
                      <div className="flex items-start gap-4 mb-5">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-xs">خدمة تقديم طلبات التصالح في مخالفات البناء</p>
                        </div>
                      </div>
                      ...
                      <div className="bg-gradient-to-l from-blue-50 to-indigo-50/50 rounded-2xl p-5 mb-6">
                        <p className="text-gray-700 leading-loose text-base">
                          هي خدمة المعاينة بالإحداثيات والتسجيل علي قواعد البيانات المركزية والإفادة بوثيقة معلومات مؤمنة موضحاً بها بيانات الموقع من حيث موقف الحيز العمراني ونطاقات التصالح وكذا التواجد في ظل القانون من عدمه والرصد في منظومة المتغيرات المكانية ومناطق الإشتراطات والحظر وبيانات أخري.
                        </p>
                      </div>
                    ...
                    >
                      <div className="flex items-start gap-4 mb-6">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-xs">يرجى التأكد من توافر كافة الوثائق الرسمية</p>
                        </div>
                      </div>
