...
const TIERS = [
  { label: 'حتى 500 م²', amount: '4,000.00' },
  { label: 'حتى 1,000 م²', amount: '8,000.00' },
  { label: 'حتى 2,000 م²', amount: '9,999.00' },
  { label: 'حتى 4,200 م²', amount: '10,999.00' },
];

const FEES = [
  { label: 'الرسوم الثابتة', amount: '3,000.00' },
...
const SurveyingLift = () => {
  ...
  const handleTrack = (e) => {
    ...
    setTrackResult({
      code: requestCode,
      status: 'طلبك قيد المراجعة الفنية لدى قسم الأعمال المساحية.',
    });
  };
  ...
  return (
    <div className="bg-[#f8fafc] min-h-screen font-cairo overflow-x-hidden" dir="rtl">
      ...
      <PageHero title="رفع مساحي" subtitle="خدمة رقمية موثقة بالكامل — تقديم إلكتروني دون الحاجة لزيارة المركز" />
          ...
          <div className="lg:col-span-4 flex flex-col order-2 lg:order-1">
            ...
            >
              ...
              <div className="bg-white px-6 py-3">
                <p className="text-gray-400 text-[11px] font-bold mb-2 text-right">جدول الشرائح</p>
                <div className="divide-y divide-gray-100">
                  {TIERS.map(({ label, amount }, i) => (
                    <div key={i} className="flex items-center justify-between py-2">
                      <span className="text-navy font-bold text-sm tabular-nums">{amount}<span className="text-[10px] font-bold text-gray-400 mr-1">ج.م</span></span>
              ...
              <div className="bg-white px-6 pb-2 divide-y divide-gray-100 border-t-2 border-dashed border-gray-200">
              ...
              <div className="bg-[#f4f7f9] px-6 py-4 flex items-center justify-between border-t border-gray-100">
                <div>
                  <span className="text-2xl font-black text-navy tabular-nums tracking-tight">3,435.00</span>
                    ...
                    >
                      <div className="flex items-start gap-4 mb-5">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-xs">خدمة الرفع المساحي بالإحداثيات</p>
                        </div>
                      </div>

                      <div className="bg-gradient-to-l from-blue-50 to-indigo-50/50 rounded-2xl p-5 mb-6">
                        <p className="text-gray-700 leading-loose text-base font-bold">
                          خدمة الرفع بالأجهزة المساحية والمخرجات علي شهادات مؤمنة بالأنظمة الإحداثية الثلاثة بالأبعاد مسقطاً علي صورة فضائية .
                        </p>
                        <p className="text-gold text-sm mt-3 leading-relaxed">
                          يرجى التأكد من تحديد الغرض من خدمة الرفع المساحي سواء التقدم لصلاحية الموقع ، أو غرض شخصي .
                        </p>
                      </div>
                  ...
                  {activeTab === 'documents' && (
                    ...
                    >
                      ...
                      <div className="space-y-3">
                        {[
                          'صورة الرقم القومي.',
                          'صورة كروكي معتمدة من مكتب هندسي .',
                          'صورة سند الملكية.',
                        ].map((doc, idx) => (
                          <div key={idx} className="flex items-center gap-3 bg-[#f8fafc] border border-gray-100 hover:border-gold/30 hover:bg-gold/5 p-4 rounded-2xl transition-all duration-200 group">
                            <div className="w-8 h-8 rounded-xl bg-gold/15 flex items-center justify-center shrink-0 group-hover:bg-gold/25 transition-colors">
                              <HiCheckCircle className="text-gold" size={18} />
                            </div>
                            <span className="text-gray-700 text-base font-bold leading-snug">{doc}</span>
                          </div>
                        ))}
                      </div>
                    </motion.div>
