...
const BuildingPermits = () => {
  ...
  const handleTrack = (e) => {
    ...
    setTrackResult({
      code: requestCode,
      status: 'طلبك قيد المراجعة الفنية لدى قسم المتغيرات المكانية.',
    });
  };
  ...
  return (
    <div className="bg-[#f8fafc] min-h-screen font-cairo overflow-x-hidden" dir="rtl">
      ...
      <PageHero title="رخص البناء" subtitle="خدمة رقمية موثقة بالكامل — تقديم إلكتروني دون الحاجة لزيارة المركز" />
                    ...
                    >
                      <div className="flex items-start gap-4 mb-5">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-xs">خدمة التسجيل إلكترونياً لرخص البناء</p>
                        </div>
                      </div>
                      ...
                      <div className="bg-gradient-to-l from-blue-50 to-indigo-50/50 rounded-2xl p-5 mb-6">
                        <p className="text-gray-700 leading-loose text-base">
                          هي خدمة المعاينة بالإحداثيات والتسجيل على قواعد البيانات المركزية والإفادة بوثيقة معلومات مؤمنة موضحاً بها بيانات الموقع من حيث موقف الحيز العمراني والرصد في منظومة المتغيرات المكانية ومناطق الاشتراطات والحظر وبيانات أخرى.
                        </p>
                      </div>
