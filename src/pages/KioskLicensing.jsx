...
const FEES = [
  { label: 'المقابل الفني', amount: '300.00' },
  { label: 'ضريبة القيمة المضافة (14%)', amount: '42.00', plus: true },
  { label: 'دمغة الشهداء', amount: '5.00' },
  { label: 'مقابل المتابعة (SMS)', amount: '10.00' },
];

const KioskLicensing = () => {
  ...
  const handleTrack = (e) => {
    ...
    setTrackResult({
      code: requestCode,
      status: 'طلبك قيد المراجعة الفنية لدى لجنة رخص الأكشاك.',
    });
  };
  ...
  return (
    <div className="bg-[#f8fafc] min-h-screen font-cairo overflow-x-hidden" dir="rtl">
      ...
      <PageHero title="رخصة أكشاك" subtitle="خدمة رقمية موثقة بالكامل — تقديم إلكتروني دون الحاجة لزيارة المركز" />
          ...
          <div className="lg:col-span-4 flex flex-col order-2 lg:order-1">
            ...
            >
              ...
              <div className="bg-[#f4f7f9] px-6 py-4 flex items-center justify-between border-t border-gray-100">
                <div>
                  <span className="text-2xl font-black text-navy tabular-nums tracking-tight">357.00</span>
                    ...
                    >
                      <div className="flex items-start gap-4 mb-5">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-xs">خدمة ترخيص الأكشاك والمنافذ المؤقتة</p>
                        </div>
                      </div>
